...
public class BillingTest {
	...
	public void testGetCustomers() {
		Map<String,Customer> customerMap = billing.getCustomers(); 
	...
	public void testGetInvoicesOrderedByNumber() {
		assertThat(invoiceNumbers(billing.getInvoicesOrderedByNumber()),
				contains(1, 2, 3, 4, 5, 6));
	}
	
	@Test
	public void testGetInvoicesOrderedByDate() {
		assertThat(invoiceNumbers(billing.getInvoicesOrderedByDate()),
	...
	public void testGetInvoicesGroupedByCustomer() {
		...
		assertThat(invoiceNumbers(map.get(GOOD_CUSTOMERS.get(0)).stream()), 
				contains(1));
		assertThat(invoiceNumbers(map.get(GOOD_CUSTOMERS.get(1)).stream()), 
				contains(2, 3, 4));
		assertThat(invoiceNumbers(map.get(GOOD_CUSTOMERS.get(2)).stream()), 
				contains(5, 6));
	}

	@Test
	public void testGetOverdueInvoices() {
		assertThat(invoiceNumbers(billing.getOverdueInvoices(AS_OF_DATE)),
				contains(4, 6, 1));
	}
	...
	public void testCreateCustomer() throws IOException {
		billing.createCustomer("Customer", "Four", Terms.CASH);
	...
	public void testCreateInvoice() throws IOException {
		billing.createInvoice(GOOD_CUSTOMERS.get(0).getName(), 999);
		try ( Stream<String> lines = 
